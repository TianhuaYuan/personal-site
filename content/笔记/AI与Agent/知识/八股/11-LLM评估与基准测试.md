...
## 
> ▶ 对应实操：[[11-Agentic RAG：LLM 主动决策多次检索 vs 传统单次被动检索|11-Agentic RAG：LLM 主动决策多次检索 vs 传统单次被动检索]]
...
A：**LLM 评估** 是衡量大语言模型能力、质量和适用性的系统化过程。评估是模型选型、优化和部署决策的基础。
...
**Q6：核心速记主线有哪些？**
A：抓住这几根：核心概念、主流基准测试、评估框架、人工评估 vs 自动化评估、LLM A/B 测试、领域特定评估。
