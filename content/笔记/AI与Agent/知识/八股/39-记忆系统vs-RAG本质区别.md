...
---
---
**本篇建立在哪篇之上**：① jieba 分词 + BM25 关键词检索（你已知道「检索 = 从资料库捞出最相关几段文字」）。本篇只需要这个直觉即可，会当场讲清 RAG 和 Agent 各自是什么、核心区别在哪。

**Q6：核心速记主线有哪些？**
A：抓住这几根：核心区别、类比理解、何时用记忆，何时用 RAG？、记忆 + RAG 融合、0. 先讲人话（生活化类比开篇）、1. 它是什么 / 为什么需要它。
