...
- 项目实践：[[项目实战/ai-resume笔记/01_技术研读/02_RAG流水线#第 6 层：拒答门控|ai-resume: RAG流水线]]
...
A：Self-RAG 在生成序列中插入四种特殊令牌来实现自评：
| 令牌 | 作用 |
|-|-|
|  | 判断是否需要检索 |
|  | 判断检索文档是否与问题相关 |
...
**Q3：代码实现：用 Python 工程化落地 Self-RAG 四令牌闭环 —— 怎么理解？**
A：以下代码将论文中的反思令牌用"小 critic 节点 + 规则"替代微调，可直接运行。
...
**Q5：核心速记主线有哪些？**
A：抓住这几根：一、原理速览、代码实现：用 Python 工程化落地 Self-RAG 四令牌闭环、。
