...
```python
# 场景：电商产品推荐
# 知识图谱包含：产品、类别、品牌、用户、购买记录等

# 查询示例：
# 1. "和iPhone 15类似的产品有哪些？"
# 2. "购买iPhone 15的用户还买了什么？"
# 3. "苹果品牌的高端产品有哪些？"
...
**Q3：2. LangChain GraphCypherQAChain —— 怎么理解？**
A：**GraphCypherQAChain**：LangChain提供的链，用于将自然语言问题转换为Cypher查询，然后在知识图谱上执行查询。

**Q4：核心速记主线有哪些？**
A：抓住这几根：1. 图谱增强检索基础、2. LangChain GraphCypherQAChain、3. 向量+图谱混合检索、4. 高级特性、5. 实际应用案例、6. 性能优化。
