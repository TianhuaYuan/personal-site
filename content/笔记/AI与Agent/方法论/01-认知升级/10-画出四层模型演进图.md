...
A：**能画出四层模型演进图，是展示全局认知最有力的动作**——无论是技术评审、方案汇报还是团队科普，一张图胜过千言。
---
...
**Q3：二、演进时间线（Mermaid） —— 怎么理解？**
A：---

**Q4：三、嵌套关系图（Mermaid） —— 怎么理解？**
A：每层都把人往上「退」了一格：从手写 Prompt → 策展 Context → 搭 Harness → 设计 Loop。
---

**Q5：四、每层关键数据 —— 怎么理解？**
A：| 层级 | 管什么 | 代表实践 | 出现时间 | 代表人物 |
|------|--------|----------|----------|----------|
| **Prompt Engineering** | 你怎么问 | 清晰指令、Few-shot、输出格式 | 2022–2024 | — |

**Q6：核心速记主线有哪些？**
A：抓住这几根：一、核心观点、二、演进时间线（Mermaid）、三、嵌套关系图（Mermaid）、四、每层关键数据、五、为什么这张图在 2026 年尤其重要、六、学习资源。
