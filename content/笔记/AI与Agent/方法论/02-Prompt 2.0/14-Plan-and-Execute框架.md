...
A：**Plan-and-Execute（先计划再执行）**：适合步骤固定的确定性任务。
像出差前先列好行程单——哪天飞、住哪、见谁都排好，到了当地照单走，不用每五分钟重新想「下一步干嘛」。
---
...
**Q4：三、优缺点 —— 怎么理解？**
A：✅ 减少中途跑偏；子步骤可并行；成本可控（计划一次，执行多次）
❌ 环境变化时计划可能过时；不够灵活；制定计划需额外 LLM 调用
---

**Q5：四、适用场景 —— 怎么理解？**
A：✅ 步骤清晰、可预先分解的确定性任务：报告生成、数据处理、工作流
❌ 路径不确定、需随时调工具返回的任务（用 ReAct）
---

**Q6：核心速记主线有哪些？**
A：抓住这几根：一、核心观点、二、定义与原理（类比先行）、三、优缺点、四、适用场景、五、生产建议：混合使用、六、最新研究与企业数据（2024–2026）。
