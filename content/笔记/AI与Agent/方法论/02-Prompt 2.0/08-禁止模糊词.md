...
A：你雇人写代码，合同写「尽量周五前交付」——周五没交付，他没错，因为你没说死。模糊词在 Prompt 里干的就是这事：给 Agent 合法摸鱼的空间。
| 模糊词 | 为什么危险 | 替换写法 |
|--------|------------|----------|
|  | 没承诺，失败也能交差 | 「必须完成；失败则报告原因」 |
|  | 可做可不做 | 「必须满足 A，否则失败」 |
|  | 直接给退路 | 「先检查可行性；
...
**Q6：核心速记主线有哪些？**
A：抓住这几根：一、核心观点、二、定义与原理（类比先行）、三、为什么危险？、四、示例对比、五、实践提示、六、最新研究与企业数据（2024–2026）。
