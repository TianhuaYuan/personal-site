...
- 🔗 [[八股文笔记/MySQL/23-redo_log与undo_log与binlog|MySQL日志系统]] — MySQL和Redis的持久化机制对比
- 🔗 [[八股文笔记/操作系统/19-零拷贝sendfile_mmap_splice|零拷贝]] — 持久化中的IO优化技术
- 🔗 [[八股文笔记/分布式-系统设计/06-消息队列MQ|消息队列]] — 持久化与消息可靠投递的关联
