...
> 本篇聚焦**把 LLM 部署成一个高吞吐、低延迟、可弹性伸缩的在线服务**。底层优化原理（KV Cache、连续批处理、量化等）见 [[笔记/八股文笔记/AI-LLM-RAG-Agent/73-LLM推理优化|LLM推理优化]]、[[笔记/八股文笔记/AI-LLM-RAG-Agent/65-AI应用架构设计|AI应用架构设计]]。
...
- **量化**：KV Cache 量化（INT8/INT4）显著降低显存，见 [[笔记/八股文笔记/AI-LLM-RAG-Agent/73-LLM推理优化|LLM推理优化]]。
...
- [[笔记/八股文笔记/AI-LLM-RAG-Agent/65-AI应用架构设计|AI应用架构设计]]
