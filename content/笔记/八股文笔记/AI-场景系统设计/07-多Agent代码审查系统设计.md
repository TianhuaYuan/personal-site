...
> 典型**多 Agent 协作**落地：用 Supervisor-Worker 架构把一次 Code Review 拆给多个专职 Agent 并行审，再聚合报告。协作模式总览见 [[笔记/八股文笔记/AI-LLM-RAG-Agent/29-多Agent协作基础与框架选型|多Agent协作Multi-Agent]]、[[笔记/八股文笔记/AI-LLM-RAG-Agent/23-Agent架构与核心组件|Agent架构与ReAct]]。
...
- 多 Agent 的通信与一致性问题见 [[笔记/八股文笔记/AI-LLM-RAG-Agent/29-多Agent协作基础与框架选型|多Agent协作Multi-Agent]]、[[笔记/八股文笔记/AI-LLM-RAG-Agent/43-多Agent编排四种模式|多Agent编排模式]]、[[45-多Agent幻觉放大问题与解决方案|多Agent幻觉放大]]。
...
- [[笔记/八股文笔记/AI-LLM-RAG-Agent/43-多Agent编排四种模式|多Agent编排四种模式]]
- [[笔记/八股文笔记/AI-LLM-RAG-Agent/45-多Agent幻觉放大问题与解决方案|多Agent幻觉放大问题]]
- [[八股文学习清单]]
- [[00-全局导航|全局导航]]
