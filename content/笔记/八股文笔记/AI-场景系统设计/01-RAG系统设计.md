...
> 本篇定位为**系统设计层**：如何把"外部知识可靠接入 LLM 生成链路"落成一个可上线、可观测、可优化的系统。原理细节（分块/Embedding/混合检索/Re-ranker）见 [[笔记/八股文笔记/AI-LLM-RAG-Agent/13-RAG检索增强生成|RAG检索增强生成]]、[[笔记/八股文笔记/AI-LLM-RAG-Agent/14-文档解析与分块策略|文档解析与分块策略]]、[[笔记/八股文笔记/AI-LLM-RAG-Agent/17-语义搜索与混合检索|语义搜索与混合检索]]。
...
详见 [[笔记/八股文笔记/AI-LLM-RAG-Agent/14-文档解析与分块策略|文档解析与分块策略]]。
...
- [[笔记/八股文笔记/AI-LLM-RAG-Agent/15-Embedding向量化|Embedding向量化]]
- [[笔记/八股文笔记/AI-LLM-RAG-Agent/16-向量数据库|向量数据库]]
