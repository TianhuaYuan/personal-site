...
- 📋 目录：[[00-Python]]
- 📚 学习清单：[[八股文学习清单]]
- 🔗 [[笔记/八股文笔记/Python/基础/07-装饰器本质与手写|装饰器本质与手写]] — 带参装饰器 = 普通装饰器外再包一层工厂
- 🔗 [[笔记/八股文笔记/Python/基础/09-functools-wraps的作用|functools.wraps的作用]] — 三层装饰器更别忘了 wraps
- 🔗 [[笔记/八股文笔记/Python/基础/06-闭包原理|闭包原理]] — 三层嵌套全是闭包
- 🔗 [[八股文笔记/React-TS-JS/JavaScript/11-闭包Closure|JS闭包]] — JS 装饰器提案对比
