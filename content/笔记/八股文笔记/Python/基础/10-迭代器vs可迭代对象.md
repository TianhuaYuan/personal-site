...
- 📋 目录：[[00-Python]]
- 📚 学习清单：[[八股文学习清单]]
- 🔗 [[笔记/八股文笔记/Python/基础/11-列表推导式vs生成器表达式|列表推导式vs生成器表达式]] — 生成器表达式返回的就是迭代器
- 🔗 [[笔记/八股文笔记/Python/并发/10-生成器与yield原理|生成器与yield原理]] — 生成器是最常用的迭代器
- 🔗 [[笔记/八股文笔记/Python/并发/12-yield from委托生成器|yield from委托生成器]] — 委托给另一个迭代器
- 🔗 [[八股文笔记/设计模式/00-设计模式|设计模式八股文]] — 迭代器模式在 OOP 中的定位
- 🔗 [[八股文笔记/操作系统/00-操作系统|操作系统八股文]] — 迭代/遍历与底层数据结构的关联
