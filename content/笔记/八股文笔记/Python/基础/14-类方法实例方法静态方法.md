...
- 📋 目录：[[00-Python]]
- 📚 学习清单：[[八股文学习清单]]
- 🔗 [[笔记/八股文笔记/Python/基础/12-面向对象三大特性|面向对象三大特性]] — 方法是封装的体现
- 🔗 [[笔记/八股文笔记/Python/基础/15-__new__vs__init__|__new__vs__init__]] — 类方法与对象创建的联系
- 🔗 [[八股文笔记/设计模式/00-设计模式|设计模式八股文]] — 工厂模式常用类方法
- 🔗 [[八股文笔记/操作系统/00-操作系统|操作系统八股文]] — 方法与对象的运行模型
