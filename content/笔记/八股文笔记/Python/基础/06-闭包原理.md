...
- 📋 目录：[[00-Python]]
- 📚 学习清单：[[八股文学习清单]]
- 🔗 [[笔记/八股文笔记/Python/基础/05-LEGB作用域与global-nonlocal|LEGB作用域]] — 闭包依赖 Enclosing 作用域
- 🔗 [[笔记/八股文笔记/Python/基础/07-装饰器本质与手写|装饰器本质与手写]] — 装饰器是闭包最典型的应用
- 🔗 [[八股文笔记/React-TS-JS/JavaScript/11-闭包Closure|JS闭包]] — Python 闭包 vs JS 闭包对比
- 🔗 [[八股文笔记/React-TS-JS/React/04-为什么需要Hooks|React Hooks]] — Hooks 用闭包"记住"状态，理念相通
