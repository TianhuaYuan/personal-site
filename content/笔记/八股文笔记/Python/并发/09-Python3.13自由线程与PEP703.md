...
- 📋 目录：[[00-Python]]
- 📚 学习清单：[[八股文学习清单]]
- 🔗 [[笔记/八股文笔记/Python/并发/05-GIL是什么|GIL是什么]] — 理解 GIL 才能理解为什么要去掉它
- 🔗 [[笔记/八股文笔记/Python/并发/06-GIL为什么存在|GIL为什么存在]] — GIL 的历史与存在理由
- 🔗 [[笔记/八股文笔记/Python/并发/07-GIL对多线程的影响|GIL对多线程的影响]] — 自由线程解决了什么
- 🔗 [[笔记/八股文笔记/Python/基础/04-引用计数与垃圾回收|引用计数与垃圾回收]] — 偏向引用计数的前身
- 🔗 [[八股文笔记/操作系统/00-操作系统|操作系统八股文]] — 多核并行与锁的底层视角
