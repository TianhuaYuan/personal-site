...
- 📋 目录：[[00-MySQL]]
- 📚 学习清单：[[八股文学习清单]]
- 🔗 [[八股文笔记/MySQL/20-事务隔离级别与MVCC|事务隔离级别与MVCC]] — MVCC在不同隔离级别下的行为差异
- 🔗 [[八股文笔记/MySQL/23-redo_log与undo_log与binlog|redo_log与undo_log与binlog]] — UndoLog是MVCC的底层支撑
- 🔗 [[八股文笔记/操作系统/03-线程同步锁机制|线程同步锁机制]] — 对比OS级和数据库级的并发控制机制
