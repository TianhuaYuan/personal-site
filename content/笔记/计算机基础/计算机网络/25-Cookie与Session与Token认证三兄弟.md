...
A：的经典连环问：Cookie 是什么？Session 是什么？Token 又是什么？它们有什么区别？为什么有了 Cookie+Session 还要用 JWT？一个一个拆。
**服务器在响应头里说："记住这个"**
**浏览器收到 → 存到本地 Cookie 仓库 → 下次访问同域名自动带**
**服务器读取 Cookie → 知道你是谁 → 返回你的个人资料**

**Q2：第四章：Cookie、Session、Token——认证三兄弟到底什么关系 —— 怎么理解？**
A：的经典连环问：Cookie 是什么？Session 是什么？Token 又是什么？它们有什么区别？为什么有了 Cookie+Session 还要用 JWT？一个一个拆。
**服务器在响应头里说："记住这个"**
**浏览器收到 → 存到本地 Cookie 仓库 → 下次访问同域名自动带**
**服务器读取 Cookie → 知道你是谁 → 返回你的个人资料**
...
**Q3：核心速记主线有哪些？**
A：抓住这几根：第四章：Cookie、Session、Token——认证三兄弟到底什么关系。
