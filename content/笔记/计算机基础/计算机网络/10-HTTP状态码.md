...
**Q1：一句话讲清「HTTP状态码」到底是什么？**

A：HTTP 状态码是服务器返回的三位数回应码，用五大类告诉你请求结果是成功、重定向还是出错。

**Q2：五大类速记：1继续 2成功 3搬家 4你的锅 5我的锅 —— 怎么理解？**

A：像餐厅小纸条：1xx 服务员说收到了、2xx 菜上来了、3xx 搬到新地址、4xx 你点错菜、5xx 厨房着火(Status Code Class)。

**Q3：常见 2xx/3xx：200/201/301/304 —— 怎么理解？**

A：像上菜的不同结果：200 成功、201 创建成功、301 永久搬家(浏览器记住)、304 没变用缓存(Not Modified)。

**Q4：常见 4xx：401 没认证 403 没权限 404 找不到 —— 怎么理解？**

A：像进公司大楼：401 没工牌先去办、403 有工牌但不是 CEO 进不去、404 要找的页面不存在(Client Error)。

**Q5：常见 5xx：500 崩了 502 上游挂 503 歇业 504 超时 —— 怎么理解？**

A：像后厨出状况：500 代码 bug、502 上游服务挂、503 过载维护、504 等上游等太久(Server Error)。

**Q6：核心速记主线有哪些？**

- 五大类：1继续 2成功 3重定向 4客户端错 5服务端错

- 2xx：200 成功 / 201 创建 / 204 无返回体

- 3xx：301 永久(缓存) / 302 临时 / 304 用缓存

- 4xx vs 5xx：401 未认证、403 无权限、404 不存在；500/502/503/504 服务端
