...
A：**Pod**：K8s中最小的部署单元，包含一个或多个容器，共享网络和存储。
| 状态 | 说明 |
|------|------|
| Pending | 等待调度 |
| Running | 运行中 |
...
**Q3：2. Service 基础 —— 怎么理解？**
A：**Service**：为一组Pod提供稳定的网络访问入口，实现负载均衡和服务发现。
| 类型 | 说明 | 适用场景 |
|------|------|----------|
| ClusterIP | 集群内部访问 | 内部服务 |
| NodePort | 节点端口暴露 | 开发测试 |
...
**Q4：3. Deployment 基础 —— 怎么理解？**
A：**Deployment**：管理Pod的副本数、滚动更新和回滚，提供声明式应用管理。

**Q5：核心速记主线有哪些？**
A：抓住这几根：1. Pod 基础、2. Service 基础、3. Deployment 基础、4. 三者关系、5. 滚动更新、6. 实际案例。
