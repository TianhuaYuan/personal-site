...
A：**pytest-asyncio**：pytest的异步测试插件，支持async/await语法。

**Q2：1. pytest-asyncio 基础 —— 怎么理解？**
A：**pytest-asyncio**：pytest的异步测试插件，支持async/await语法。

**Q3：2. Fixture 链 —— 怎么理解？**
A：**Fixture链**：多个fixture之间的依赖关系，形成链式调用。

**Q4：3. ASGITransport 无服务器测试 —— 怎么理解？**
A：**ASGITransport**：httpx提供的传输层，可以直接调用ASGI应用，无需启动服务器。

**Q5：核心速记主线有哪些？**
A：抓住这几根：1. pytest-asyncio 基础、2. Fixture 链、3. ASGITransport 无服务器测试、4. 测试数据库、5. 高级用法、6. 实际案例。
