...
A：**GitHub Actions**：GitHub提供的CI/CD平台，允许自动化构建、测试和部署流程。

**Q2：1. GitHub Actions 基础 —— 怎么理解？**
A：**GitHub Actions**：GitHub提供的CI/CD平台，允许自动化构建、测试和部署流程。

**Q3：核心速记主线有哪些？**
A：抓住这几根：1. GitHub Actions 基础、2. 完整CI流水线、3. Pre-commit 集成、4. 测试覆盖率、5. 缓存优化、6. 实际案例。
...
- 项目实践：[[项目实战/cr-agent笔记/01-技术研读/08-GitHub集成|cr-agent: GitHub集成]]
