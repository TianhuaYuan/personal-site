...
A：**单机 Redis 存不下就分片——Cluster 把数据分成 16384 个槽，每个节点负责一部分槽。客户端算好 key 属于哪个槽，直接找对应的节点要数据。节点挂了，槽自动移到其他节点，不停机。**
---
...
**Q3：🌰 理解为什么需要集群 —— 怎么理解？**
A：你是一家店老板，生意越做越大，问题来了：
**这就是 Cluster 做的事：多台 Redis 一起干活，每台只存一部分数据。**
---

**Q4：核心概念：哈希槽（Hash Slot） —— 怎么理解？**
A：**每个节点只存一部分数据，合起来就是全部。**
---

**Q5：数据读写流程 —— 怎么理解？**
A：**核心：客户端知道数据在哪，不需要像哨兵那样"问一圈"。**
---

**Q6：核心速记主线有哪些？**
A：抓住这几根：一句话总结、🌰 理解为什么需要集群、核心概念：哈希槽（Hash Slot）、数据读写流程、三种节点角色、主节点挂了怎么办？——自动故障转移。
...
- 📋 目录：[[00-Redis]]
- 📚 学习清单：[[八股文学习清单]]
- 🔗 [[计算机基础/分布式-系统设计/02-微服务架构|微服务架构]] — 数据分片与服务拆分的设计思路
- 🔗 [[计算机基础/计算机网络/34-DNS解析过程|DNS解析过程]] — 一致性哈希与DNS调度的类比
- 🔗 [[计算机基础/操作系统/20-操作系统基础CPU调度流程中断系统调用上下文切换|上下文切换]] — 分布式节点间的请求调度
