...
### 2.5 手写极简版 useState（15 行理解原理，不背）
...
# Python 伪代码——帮助理解 useState 的"链表记状态"机制
...
**Q1：一句话讲清「Python 伪代码——帮助理解 useState 的"链表记状态"机制」到底是什么？**
A：核心："函数组件每次渲染都重新执行，state 凭什么能保留？"
你写的  是一个**函数调用**。这个调用做了两件事：
| 步骤 | 发生了什么 | 类比 |
| :--- | :--- | :--- |

**Q2：二、useState 底层机制 —— 怎么理解？**
A：核心："函数组件每次渲染都重新执行，state 凭什么能保留？"
你写的  是一个**函数调用**。这个调用做了两件事：
| 步骤 | 发生了什么 | 类比 |
| :--- | :--- | :--- |
