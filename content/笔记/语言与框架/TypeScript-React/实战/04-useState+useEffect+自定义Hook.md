...
A：**useState**：React Hook，用于在函数组件中添加状态。

**Q2：1. useState —— 怎么理解？**
A：**useState**：React Hook，用于在函数组件中添加状态。

**Q3：2. useEffect —— 怎么理解？**
A：**useEffect**：React Hook，用于处理组件的副作用（如数据获取、订阅、手动修改DOM等）。

**Q4：3. 自定义Hook —— 怎么理解？**
A：**自定义Hook**：以"use"开头的函数，用于复用状态逻辑。

**Q5：核心速记主线有哪些？**
A：抓住这几根：1. useState、2. useEffect、3. 自定义Hook、4. 实际案例、5. 常见坑点、核心要点。
