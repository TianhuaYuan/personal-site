...
# 选择建议：
# 1. LangGraph状态 → TypedDict（更轻量，与LangGraph集成更好）
# 2. 配置、值对象 → frozen dataclass
# 3. 需要方法 → 普通类
```
...
### 3. 与 TypedDict 的兼容性
```python
# Python 3.8 以下需要从 typing_extensions 导入
...
**Q4：核心速记主线有哪些？**
A：抓住这几根：1. 为什么需要 TypedDict？、2. 核心特性、3. 基础用法、4. 在 LangGraph 中的应用、5. 高级特性、6. 常见坑点。
