...
A：回顾 Day 03 的猜数字游戏，常见问题和优化：

**Q2：1. 作业讲解 —— 怎么理解？**
A：回顾 Day 03 的猜数字游戏，常见问题和优化：

**Q3：3. range 函数 —— 怎么理解？**
A：range 是 for 循环的最佳搭档：
[!tip] range 不是列表
 返回的是一个 range 对象，它只在需要时生成数字，内存占用极小。

**Q4：4. 循环嵌套 —— 怎么理解？**
A：**输出：**

**Q5：核心速记主线有哪些？**
A：抓住这几根：1. 作业讲解、2. for 循环、3. range 函数、4. 循环嵌套、5. continue、break、pass、else、6. 序列介绍。
