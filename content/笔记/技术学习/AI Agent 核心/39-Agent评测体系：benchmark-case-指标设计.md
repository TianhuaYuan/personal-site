...
- 目录：[[00-AI]]
- 项目实践：[[笔记/技术学习/项目开发笔记/cr-agent笔记/01-技术研读/09-LLM评测体系搭建.md#第一级：Judge 核心（judge.py 🔴）|cr-agent: LLM评测体系搭建]]
- 项目实践：[[笔记/技术学习/项目开发笔记/cr-agent笔记/01-技术研读/00-17条架构决策总览.md#决策 15: 评测用「软硬双指标」——LLM-as-Judge + PRF|cr-agent: 决策15-软硬双指标]]
