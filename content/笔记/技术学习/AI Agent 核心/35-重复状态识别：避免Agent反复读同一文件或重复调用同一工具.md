...
- 项目实践：[[笔记/技术学习/项目开发笔记/ai-resume笔记/01_技术研读/03_LangGraph状态机.md#Checkpoint 机制|ai-resume: LangGraph]]
- 项目实践：[[笔记/技术学习/项目开发笔记/cr-agent笔记/01-技术研读/01-Supervisor-Worker编排与StateGraph.md#🔴 记忆级：graph.py + state.py 逐行精读|cr-agent: StateGraph]]
