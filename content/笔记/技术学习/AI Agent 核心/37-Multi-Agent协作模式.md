...
- 项目实践：[[笔记/技术学习/项目开发笔记/cr-agent笔记/01-技术研读/01-Supervisor-Worker编排与StateGraph.md#🔴 记忆级：graph.py + state.py 逐行精读|cr-agent: Supervisor-Worker编排]]（4 个 Worker: Quality/Security/Performance/Structure）
- 项目实践：[[笔记/技术学习/项目开发笔记/ai-resume笔记/01_技术研读/03_LangGraph状态机.md#直接模式 vs MCP 模式|ai-resume: LangGraph状态机]]
