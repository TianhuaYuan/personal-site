...
- 项目实践：[[笔记/技术学习/项目开发笔记/cr-agent笔记/01-技术研读/09-LLM评测体系搭建.md#第三级：周边能力（🟢 一句话总结 + 位置）|cr-agent: Langfuse可观测性]]
- 项目实践：[[笔记/技术学习/项目开发笔记/cr-agent笔记/01-技术研读/00-17条架构决策总览.md#决策 16: 成本控制用 TokenMeter 包 client（不侵入 Worker）|cr-agent: 决策16-成本控制]]
