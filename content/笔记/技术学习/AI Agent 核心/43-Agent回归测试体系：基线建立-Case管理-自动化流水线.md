...
- 项目实践：[[笔记/技术学习/项目开发笔记/cr-agent笔记/01-技术研读/09-LLM评测体系搭建.md#第二级：评测主流程（eval.py 🟡）|cr-agent: LLM评测体系]]
- 项目实践：[[笔记/技术学习/项目开发笔记/cr-agent笔记/01-技术研读/00-17条架构决策总览.md#决策 17: 评测 CLI 的 token 计量开关 + 模块函数还原（第三版收尾补丁）|cr-agent: 决策17-评测CLI]]
